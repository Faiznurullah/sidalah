...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Tambah Siswa Sekolah</h6>
    </div>
<div class="card-body">
    <div class="table-responsive">
        ...
        <form action="/siswa/insert/" enctype="multipart/form-data" method="POST">
            @csrf
            @method('POST')
      ...
      <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="number" value="{{ old('nis') }}" class="form-control  @error('nip') is-invalid @enderror is-valid" name="nis" id="exampleFormControlInput1" placeholder="Nis Siswa...">
     ...
     <div class="alert alert-danger">{{ $message }}</div>
      ...
      <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" value="{{ old('nama') }}" class="form-control  @error('nama') is-invalid @enderror is-valid" name="nama" id="exampleFormControlInput1" placeholder="Nama Siswa...">
            <div class="valid-feedback">
                @error('nama')
    <div class="alert alert-danger">{{ $message }}</div>
             @enderror
